...
| #   | Feature                                                                                                                                 |
| --- | --------------------------------------------------------------------------------------------------------------------------------------- |
| 1   | View & edit the **same content** in **Markdown** (source) _and_ **RichText** (HTML) simultaneously.                                     |
...
| Build/Serve            | _None_ (pure single HTML file) | Runs directly from local disk or any static web host.                    |
